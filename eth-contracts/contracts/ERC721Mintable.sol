...
contract Ownable {
    ...
    */
    ...
    {
        require(msg.sender == _owner, "Callers Address is not valid");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Duplicate Owner Error: 'to' address is the owner of the 'tokenId'");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(_owner, msg.sender), "The Owner is not approved.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "'from' must be the owner of the token");
...
contract CustomERC721Token is ERC721Metadata {
    string private name = "Blockchain Real Estate Market";
    string private symbol = "ERC721";
    string URI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";
